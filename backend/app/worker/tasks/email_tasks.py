...
def send_report_ready_task(self, to_email: str, full_name: str | None, report_name: str, report_url: str):
    ...
    try:
        ...
        logger.info(f"[Task: send_report_ready] ✅ Sent to {to_email} | report={report_name}")
    except Exception as exc:
...
def send_team_invite_task(self, to_email: str, invited_by: str, org_name: str, invite_url: str):
