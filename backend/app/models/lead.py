...
class Lead(Base):
    ...
    company_size: Mapped[str | None]         = mapped_column(String(50), nullable=True)   # "1-10", "11-50" ...
    ...
    expected_data_volume: Mapped[str | None] = mapped_column(String(100), nullable=True)  # "< 10GB", "10–100GB" ...
    ...
    lead_id: Mapped[str] = mapped_column(String(30), nullable=False, unique=True)  # e.g. LEAD-2026-0001
    internal_notes: Mapped[str | None]   = mapped_column(Text, nullable=True)
    assigned_to: Mapped[str | None]      = mapped_column(String(200), nullable=True)  # sales rep name
    tenant_id: Mapped[uuid.UUID | None]  = mapped_column(UUID(as_uuid=True), nullable=True)  # set when provisioned
