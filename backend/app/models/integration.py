...
from sqlalchemy import String, DateTime, ForeignKey, Boolean, Float, Integer
...
class IntegrationConnection(Base):
    ...
    category: Mapped[str] = mapped_column(String(100), nullable=False)  # e.g., 'Cloud', 'AI', 'Payment', 'Storage'
    status: Mapped[str] = mapped_column(String(50), default="online")  # online, degraded, offline, maintenance
    health_score: Mapped[float] = mapped_column(Float, default=100.0)
    auth_type: Mapped[str] = mapped_column(String(50), nullable=False) # OAuth2, API_Key, IAM_Role
...
class AutomationWorkflow(Base):
    ...
    trigger_type: Mapped[str] = mapped_column(String(100), nullable=False)  # e.g., 'webhook', 'schedule', 'event'
