...
from sqlalchemy import String, Boolean, DateTime, ForeignKey, Text, JSON, BigInteger, Integer
...
class Dataset(Base):
    ...
    status: Mapped[str] = mapped_column(String(50), default=DatasetStatus.uploading, nullable=False, index=True)
    ...
    profile: Mapped[dict | None] = mapped_column(JSON, nullable=True)     # Full Pandas profile JSON
    data_quality_score: Mapped[int | None] = mapped_column(Integer, nullable=True)  # 0-100
