...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ONLINE', 'OFFLINE', 'DEGRADED', 'MAINTENANCE', name='providerstatus'), nullable=True),
    ...
    sa.Column('type', sa.Enum('CHAT', 'REASONING', 'EMBEDDING', 'VISION', 'IMAGE_GEN', 'SPEECH_TO_TEXT', 'TEXT_TO_SPEECH', 'OCR', 'FORECASTING', name='modeltype'), nullable=True),
    ...
    op.create_index(op.f('ix_ai_routing_rules_id'), 'ai_routing_rules', ['id'], unique=False)
