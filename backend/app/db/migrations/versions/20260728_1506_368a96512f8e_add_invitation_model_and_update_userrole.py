...
def upgrade() -> None:
    ...
    op.alter_column('ai_token_usage', 'prompt_tokens',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('ai_token_usage', 'completion_tokens',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('ai_token_usage', 'total_tokens',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('ai_token_usage', 'cost_usd',
    ...
    op.alter_column('ai_token_usage', 'created_at',
               ...
               server_default=None,
               existing_nullable=False)
    op.create_index(op.f('ix_ai_token_usage_feature'), 'ai_token_usage', ['feature'], unique=False)
    ...
    op.alter_column('datasets', 'status',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('datasets', 'profile',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True)
    ...
    op.alter_column('reports', 'status',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('reports', 'generation_config',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True)
    op.alter_column('reports', 'ai_blueprint',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True)
    op.alter_column('reports', 'progress',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('reports', 'ai_tokens_used',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    ...
    op.alter_column('tenants', 'max_storage_gb',
               ...
               server_default=None,
               existing_nullable=False)
    op.alter_column('tenants', 'max_ai_tokens_per_month',
               existing_type=sa.INTEGER(),
               server_default=None,
               existing_nullable=False)
    op.alter_column('tenants', 'white_label_config',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True)
    ...
    op.alter_column('workspaces', 'is_default',
               existing_type=sa.BOOLEAN(),
               server_default=None,
               existing_nullable=False)
