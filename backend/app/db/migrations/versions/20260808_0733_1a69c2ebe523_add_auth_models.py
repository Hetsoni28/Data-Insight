...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_security_events_ip_address"),
        "security_events",
        ["ip_address"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_threat_intelligence_indicator_value"),
        "threat_intelligence",
        ["indicator_value"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_integration_logs_created_at"),
        "integration_logs",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_integration_logs_integration_id"),
        "integration_logs",
        ["integration_id"],
        unique=False,
    )
