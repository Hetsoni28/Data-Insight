...
ROLE_PERMISSIONS = {
    "org_admin": [
        "DATASET_VIEW", "DATASET_ANALYZE", "DATASET_AI_EXCEL", "DATASET_CREATE_REPORT", "DATASET_CREATE_DASHBOARD", "DATASET_DELETE", "DATASET_EXPORT", "DATASET_UPLOAD",
        "REPORT_VIEW", "REPORT_CREATE", "REPORT_EDIT", "REPORT_DELETE", "REPORT_EXPORT", "REPORT_PUBLISH", "REPORT_SHARE", "REPORT_SCHEDULE", "REPORT_AI"
    ],
    "manager":   [
        "DATASET_VIEW", "DATASET_ANALYZE", "DATASET_AI_EXCEL", "DATASET_CREATE_REPORT", "DATASET_CREATE_DASHBOARD", "DATASET_DELETE_OWN", "DATASET_EXPORT", "DATASET_UPLOAD",
        "REPORT_VIEW", "REPORT_CREATE", "REPORT_EDIT", "REPORT_DELETE", "REPORT_EXPORT", "REPORT_PUBLISH", "REPORT_SHARE", "REPORT_SCHEDULE", "REPORT_AI"
    ],
    "analyst":   [
        "DATASET_VIEW", "DATASET_ANALYZE", "DATASET_AI_EXCEL", "DATASET_CREATE_REPORT", "DATASET_CREATE_DASHBOARD", "DATASET_DELETE_OWN", "DATASET_UPLOAD",
