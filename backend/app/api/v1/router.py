...
api_router.include_router(manager_dashboard_router, prefix="/manager-dashboard", tags=["Manager Dashboard"])
api_router.include_router(manager_analytics_router, prefix="/manager/analytics", tags=["Manager Analytics"])
api_router.include_router(manager_datasets_router, prefix="/manager/datasets", tags=["Manager Datasets"])
