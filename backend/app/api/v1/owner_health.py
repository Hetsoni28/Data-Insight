...
async def get_platform_health(
    ...
    return {
        "status": "success",
        "data": [
            { "id": "api", "name": "Core API", "status": "operational", "value": f"{api_latency}ms" },
            { "id": "db", "name": "Database (Primary)", "status": db_status, "value": f"{max(1, db_latency)}ms" },
            { "id": "redis", "name": "Redis Cache", "status": "operational", "value": f"{redis_latency}ms" },
