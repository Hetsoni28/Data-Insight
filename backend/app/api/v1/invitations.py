...
from app.core.exceptions import ForbiddenException, ConflictException, ResourceNotFoundException, ValidationException
import secrets
...
async def create_invitation(
    ...
    if current_user.role == UserRole.manager and body.role not in [UserRole.analyst, UserRole.viewer]:
