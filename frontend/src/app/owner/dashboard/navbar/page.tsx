    ...
    <>
      <header className="sticky top-0 z-10 bg-white/60 backdrop-blur-2xl border-b border-slate-200/60 px-8 py-3.5 flex items-center justify-between shadow-[0_1px_3px_0_rgba(0,0,0,0.02)]">
        ...
        <div className="flex items-center gap-4">
          ...
          <button onClick={() => setIsCommandOpen(true)} className="relative hidden md:flex items-center w-64 h-9 pl-3 pr-2 bg-slate-100/50 hover:bg-slate-100 border border-slate-200/60 hover:border-slate-300 rounded-xl transition-all group">
