  ...
  return (
    <div className="flex-1 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Viewer Dashboard</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-2">Welcome to the Viewer view.</p>
        </div>
        ...
        <div className="p-12 text-center bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-3xl shadow-sm">
          ...
          <p className="text-slate-500 dark:text-slate-400 max-w-sm mx-auto mt-2">
            This dashboard is completely isolated for the Viewer role. You can start adding components specific to this role here.
          </p>
        </div>
      </div>
    </div>
