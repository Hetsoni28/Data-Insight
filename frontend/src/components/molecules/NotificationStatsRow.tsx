...
export function NotificationStatsRow({ stats }: Props) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
      <StatCard label="Unread" value={stats?.unread || 0} icon={Inbox} color="text-blue-600 dark:text-blue-400" bg="bg-blue-50 dark:bg-blue-950/40" border="border-blue-100 dark:border-blue-900/30" />
      ...
      <StatCard label="Security" value={stats?.security || 0} icon={ShieldAlert} color="text-purple-600 dark:text-purple-400" bg="bg-purple-50 dark:bg-purple-950/40" border="border-purple-100 dark:border-purple-900/30" />
