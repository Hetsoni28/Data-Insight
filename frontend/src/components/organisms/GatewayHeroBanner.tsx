          ...
          <motion.div initial={{ opacity: 0, scale: 0.95, y: 10 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 10 }}
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-bold text-white">Export API Logs</h2>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2 block">Export Format</label>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95, y: 10 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 10 }}
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-bold text-white">Generate API Report</h2>
              </div>
              <button onClick={onClose} className="text-slate-400 hover:text-white transition-colors"><X className="w-5 h-5" /></button>
            </div>

            <div className="space-y-4">
              {["API Traffic Summary", "Error Rate Analysis", "Top Endpoints by Latency", "Security Events", "Developer App Usage"].map((item, i) => (
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95, y: 10 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 10 }}
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-bold text-white">{createdKey ? "API Key Created!" : "Create New API Key"}</h2>
              </div>
            ...
            {createdKey ? (
              ...
              <div className="space-y-5">
                <div>
                  <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2 block">Key Name <span className="text-red-400">*</span></label>
                ...
                <div>
                  <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2 block">Permissions / Scopes</label>
                  <div className="grid grid-cols-2 gap-2">
                    {scopeOptions.map(s => (
                ...
                <div className="flex gap-3 pt-2">
                  <Button variant="outline" onClick={handleClose} className="flex-1 bg-white/5 border-white/10 text-white hover:bg-white/10">Cancel</Button>
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="relative overflow-hidden bg-slate-900 rounded-3xl p-8 shadow-xl"
      >
