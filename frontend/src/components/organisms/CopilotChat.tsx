...
const ChatMessageBubble = memo(({
  ...
  const markdownComponents = {
    ...
    pre: ({ children }: any) => (
      <pre className="my-3 p-4 rounded-xl bg-slate-800 dark:bg-slate-950 border border-slate-700/50 overflow-x-auto text-[12px] leading-relaxed">
        {children}
      </pre>
    ),
        ...
        <div
          className={cn(
            ...
            isUser
              ...
              : "bg-white dark:bg-slate-900/80 border border-slate-100 dark:border-white/10 text-slate-800 dark:text-slate-200 rounded-bl-sm"
          )}
        >
          {isUser ? (
...
export function CopilotChat({
  ...
  return (
    <div className="flex h-[calc(100vh-9.5rem)] w-full gap-4 overflow-hidden">
      ...
      <div className="w-80 flex-shrink-0 flex flex-col rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200/80 dark:border-white/10 shadow-sm overflow-hidden">
        {/* Sidebar Header */}
        ...
        <div className="p-3 border-b border-slate-100 dark:border-white/10 bg-slate-50/50 dark:bg-slate-900/20">
          ...
          <div className="relative">
            <select
              ...
              className="w-full text-xs py-1.5 pl-7 pr-3 rounded-lg border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-emerald-500 focus:outline-none"
            >
                  ...
                  <div className="flex items-center gap-2 min-w-0 flex-1">
                    ...
                    {isEditing ? (
                      <input
                        ...
                        className="bg-white dark:bg-slate-800 px-1.5 py-0.5 rounded border border-emerald-500 text-xs w-full focus:outline-none"
                      />
                    ) : (
      ...
      <div className="flex-1 flex flex-col rounded-2xl bg-white/60 dark:bg-white/5 backdrop-blur-2xl border border-slate-200/80 dark:border-white/10 shadow-xl overflow-hidden">
        {/* Header */}
        <div className="bg-white/80 dark:bg-slate-900/40 backdrop-blur-md border-b border-slate-100 dark:border-white/10 px-5 py-2.5 flex items-center justify-between shrink-0">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-left">
                    {suggestions.map((sugg, i) => (
                      <button
                        ...
                        className="p-3 rounded-xl border border-slate-200/70 dark:border-white/10 bg-white/70 dark:bg-slate-900/40 hover:border-emerald-500/40 hover:bg-emerald-50/50 dark:hover:bg-emerald-950/20 transition-all text-xs flex items-center justify-between group shadow-sm"
                      >
            ...
            <div className="space-y-4 max-w-4xl mx-auto w-full pb-4">
              ...
              {isTyping && (
                <div className="flex justify-start items-end gap-2.5">
                  ...
                  <div className="flex items-center space-x-1.5 p-2 px-3 bg-white dark:bg-white/5 border border-slate-100 dark:border-white/10 shadow-sm rounded-2xl rounded-tl-sm h-8 w-fit">
        ...
        {suggestions.length > 0 && (
          <div className="px-4 py-2 bg-slate-50/90 dark:bg-slate-900/60 border-t border-slate-100 dark:border-white/5 flex items-center gap-2 overflow-x-auto no-scrollbar shrink-0">
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar py-0.5">
              {suggestions.slice(0, 5).map((sugg, i) => (
                <button
                  ...
                  type="button"
                  onClick={() => handleSend(sugg.question)}
                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-medium bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-white/10 hover:border-emerald-500 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50/50 dark:hover:bg-emerald-950/30 transition-all shrink-0 shadow-xs"
                >
        ...
        {/* Input Bar */}
        <div className="p-3.5 bg-white/80 dark:bg-slate-900/40 backdrop-blur-xl border-t border-slate-100 dark:border-white/10 shrink-0">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              handleSend();
