...
export function DashboardQuickActions() {
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-3xl border border-slate-200/60 shadow-sm overflow-hidden relative"
    >
      ...
      <div className="p-4 space-y-3 relative z-10">
        {actions.map((action, idx) => (
          <button
            ...
            className="w-full group relative flex items-center gap-4 p-4 rounded-2xl bg-white hover:bg-slate-50 border border-slate-100 hover:border-slate-200 transition-all text-left overflow-hidden shadow-sm hover:shadow-md"
          >
