      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 px-6 py-4 flex items-center justify-between gap-4 border-b border-slate-700/60">
        <div className="min-w-0 flex-1">
          ...
          {data.dashboardSummary && (
            <p className="text-xs text-slate-400 mt-1 leading-relaxed line-clamp-2">{data.dashboardSummary}</p>
          )}
        </div>
        <button
          onClick={handleExport}
          className="flex items-center gap-1.5 px-3 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-xs font-semibold transition-all shadow-md shrink-0"
        >
