  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        {/* Email */}
        <motion.div variants={item} className="space-y-2 relative group">
      ...
      {/* Divider */}
      <motion.div variants={item} className="flex items-center gap-3 my-8">
      ...
      <motion.p variants={item} className="text-center text-sm text-slate-500 mt-8">
        ...
        <Link href="/register" className="text-[#10B981] font-semibold hover:text-[#059669] transition-colors">
          Create one free <span aria-hidden="true">&rarr;</span>
        </Link>
      </motion.p>
    </motion.div>
  )
